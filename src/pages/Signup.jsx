                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleSignup} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div>
                                    <p className='text-base'>If you have an account. Please <Link to='/login' className='underline text-red-600'>Login Now</Link> here</p>
                                </div>
                                <div className="relative">
                                    <button type='submit' className="bg-red-500 text-white rounded px-6 py-1" >Sign up</button>
                                </div>
                            </form>
                        </div>
                    </div>
